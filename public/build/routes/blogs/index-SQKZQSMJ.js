    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "w-full md:w-3/5 lg:w-4/6 mx-auto mb-10 relative pt-8 px-6 mdLpx-0", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "grid xl:grid-cols-3 grid-cols-1 lg:grid-cols-2 justify-center mt-32", children: [
        props.blogdata.map((val, index) => {
          return index < 6 ? /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(UserCard, { name: val.userName.toString().split("@")[0], description: val.bio, imageUrl: image }, void 0, false, {
            fileName: "app/components/blogpage/blogspage.tsx",
            lineNumber: 26,
            columnNumber: 45
          }, this) }, index, false, {
...
//# sourceMappingURL=/build/routes/blogs/index-SQKZQSMJ.js.map
